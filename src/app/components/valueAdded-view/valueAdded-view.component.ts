...
@Component({
  moduleId: module.id,
  selector: 'app-valueAdded-view',
  templateUrl: './valueAdded-view.component.html',
  styleUrls: ['./valueAdded-view.component.css']

})
export class ValueAddedViewComponent implements OnInit {
